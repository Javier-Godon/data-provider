...
func main() {
	...
	repoURL := "https://github.com/Javier-Godon/data-provider"
	...
	imageAddress := fmt.Sprintf("ghcr.io/%s/data-provider:%s", strings.ToLower(username), imageTag)
	...
	payload := map[string]interface{}{
		"event_type": "image-tag-in-data-provider-go-dev-updated",
